...
import 'package:flakka_integration/src/command_runner.dart';
...
void main() {
  group('FlakkaIntegrationCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late FlakkaIntegrationCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = FlakkaIntegrationCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = FlakkaIntegrationCommandRunner();
